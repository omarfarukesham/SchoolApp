          ...
          <li tabIndex="0">
            ...
            <ul className="p-4 md:ml-6 ml-20 bg-slate-900 z-30">
              <NavLink to="/dashboard">
                <li className=" py-2 m-2">Student</li>
              </NavLink>
              <NavLink to="/teacher">
                <li className=" py-2 m-2">Teacher</li>
              </NavLink>
            </ul>
          </li>
        </ul>
    ...
    <div>
      <div className="flex justify-between items-center text-left h-24 w-full mx-auto px-4 bg-slate-900 text-white font-poppins">
        ...
        <ul
          className={
            nav
              ? "fixed z-30 left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500"
